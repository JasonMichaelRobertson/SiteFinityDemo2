...
namespace SitefinityWebApp.Areas.BugTracker.Controllers
{
    ...
    {
        private Type bugType = TypeResolutionService.ResolveType("Telerik.Sitefinity.DynamicTypes.Model.Project.Bug");
        private Type projectType = TypeResolutionService.ResolveType("Telerik.Sitefinity.DynamicTypes.Model.Project.Project");

        public ActionResult Index()
        {
           Guid projectId = new Guid(this.ControllerContext.RouteData.Values["id"].ToString());

           // int projectId = this.ControllerContext.RouteData.Values["id"].ToString();
